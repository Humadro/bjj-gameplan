...
export default function ReferenceFieldset({
  ...
  return (
    <details open={hasRef} className="rounded-md border border-black/10 px-2 py-1 dark:border-white/10">
      <summary className="cursor-pointer text-xs text-zinc-500">Enlace de estudio (opcional)</summary>
      <div className="mt-2 flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <input
            ...
            placeholder="Etiqueta (p.ej. Danaher, ep.3)"
          ...
          <input
            ...
            title="Segundo de inicio (solo YouTube)"
          />
        </div>
      </div>
    </details>
